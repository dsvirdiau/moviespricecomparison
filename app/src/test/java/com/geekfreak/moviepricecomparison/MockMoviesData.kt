...
class MockMoviesData {
   ...
   fun getCinemaWorldMovies() = Gson().fromJson(cinemaWorldMoviesJson, Movies::class.java)

   companion object {
      private const val filmWorldMoviesJson = "{\n" +
              "\t\"Provider\": \"Film World\",\n" +
              "\t\"Movies\": [\n" +
              "\t\t{\n" +
              "\t\t\t\"ID\": \"fw2488496\",\n" +
      ...
      private const val cinemaWorldMoviesJson = "{\n" +
